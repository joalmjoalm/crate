...
public class PrependInputIdRowReceiver implements RowReceiver {
    ...
    private final ArrayRow prependedRow = new ArrayRow();
    ...
    public Result setNextRow(Row row) {
        // Prepend inputId as the first column
        Object[] originalCells = row.materialize();
        Object[] cells = new Object[originalCells.length + 1];
        cells[0] = inputId;
        System.arraycopy(originalCells, 0, cells, 1, originalCells.length);
        prependedRow.cells(cells);
